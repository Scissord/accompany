...
export const Modal: FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-40 bg-black bg-opacity-50 flex items-center justify-center">
      <div
        className={`w-[100%] h-[100%] lg:w-[70%] lg:h-[80vh] rounded-lg shadow-lg p-6 lg:p-12 bg-dbg text-white overflow-y-auto`}>
        <div className='relative flex flex-col lg:grid lg:grid-cols-3 gap-6'>
          <h1 className="col-span-1 text-2xl font-semibold">Заявка</h1>
          <div className='col-span-2 fixed lg:sticky top-6 right-6 lg:top-0 lg:right-0 flex justify-end'>
            <button
