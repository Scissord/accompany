...
const Header: FC = () => {
  return (
    <header className="sticky top-0 z-30 lg:relative h-[10vh] lg:h-[40vh] bg-dbg text-white lg:bg-[url('/pages/charters/header_bg.png')] lg:bg-cover lg:bg-bottom fijb lg:block">
